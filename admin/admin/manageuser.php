...
if(isset($_GET['action']) && $_GET['action']!="" && $_GET['action']=='delete')
{
    ...
    $delete_query = mysqli_query($con,"delete from user_info where user_id='$user_id'")or die("query is incorrect...");
                    ...
                    <div class="table-responsive ps">
                        <table class="table tablesorter table-hover" id="">
                            ...
                            <tbody>
                                ...
                                while(list($user_id,$user_name,$user_last,$email,$user_password,$mobile,$address1,$address2)=mysqli_fetch_array($result))
                                {
                                    echo "<tr>
                                        <td>$user_id</td>
                                        <td>$user_name</td>
                                        ...
                                        <td>$address2</td>";
                                    echo "<td>
                                        <a class='btn btn-primary' href='edituser.php?user_id=$user_id&action=edit'>Update<div class='ripple-container'></div></a>
